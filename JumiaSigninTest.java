...
public class JumiaSigninTest {
    ...
    public class testMe {
        ...
        public void PageTitle () throws InterruptedException {
            ...
            driver.findElement(By.id("fi-email")).sendKeys("peretimi@yopmail.com");
            //Input valid password
            driver.findElement(By.id("fi-password")).sendKeys("Pereebi567");
            //Click login
        ...
        public void InvalidEmail() throws InterruptedException {
            ...
            driver.findElement(By.id("fi-email")).sendKeys("peretim845@yopmail.com");
            //Input valid password
            driver.findElement(By.id("fi-password")).sendKeys("Pereebi567");
            //Click login
        ...
        public void InvalidPassword() throws InterruptedException {
            ...
            driver.findElement(By.id("fi-password")).sendKeys("Pebi567");
            //Click login
            driver.findElement(By.xpath("//*[@id=\"authForm\"]/button/span")).click();
            Thread.sleep(2000);
