...
public class JumiaSigninTest {
    ...
    public class testMe {
        ...
        public void PageTitle () throws InterruptedException {
            //Test 4 Verify that user can signin successfully with valid details
            //Input valid email address
            driver.findElement(By.id("fi-email")).sendKeys("valid email");
            //Input valid password
            driver.findElement(By.id("fi-password")).sendKeys("valid password");
            //Click login
            ...
            if (expectedUserIcon.contains(actualUserIcon))
        ...
        public void InvalidEmail() throws InterruptedException {
            //Test 6 Verify that user cannot signin with an invalid email
            // Click on Account
            driver.findElement(By.xpath("//*[@id=\"jm\"]/header/section/div[2]/div[1]/label")).click();
            Thread.sleep(3000);
            //Click on Sign In
            ...
            driver.findElement(By.id("fi-email")).sendKeys("invalid email");
            //Input valid password
            driver.findElement(By.id("fi-password")).sendKeys("valid password");
            //Click login
        ...
        public void InvalidPassword() throws InterruptedException {
            //Test 7 Verify that user cannot signin with an invalid password
            //Clear email field
            ...
            driver.findElement(By.id("fi-password")).sendKeys("invalid password");
            //Click login
            driver.findElement(By.xpath("//*[@id=\"authForm\"]/button/span")).click();
            Thread.sleep(2000);
        ...
        public void EmptyFields() throws InterruptedException {
            //Test 8 Verify that user cannot signin leaving email and password fields empty
            //Clear email field
            Thread.sleep(1000);
            driver.findElement(By.id("fi-email")).clear();
        ...
        public void ShowPassword() throws InterruptedException {
            ...
            driver.findElement(By.id("fi-password")).sendKeys("passwordtext");
            Thread.sleep(1000);
